...
import com.kavya.pages.pageObjectModel.vwo.normal_POM.DashBoardPage;
import com.kavya.pages.pageObjectModel.vwo.normal_POM.LoginPage;
...
public class TestVWOLogin_2_Optimized extends CommonToAllTest {
    // step 1 : Driver                   D
    // step 2: Locators                  L
    // step 3 : Validation / Assertion   V

    private static final Logger logger = LogManager.getLogger(TestVWOLogin_2_Optimized.class);
